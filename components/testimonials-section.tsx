  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "Joining this gym was the best decision I made for my health. The equipment is top-notch and the atmosphere keeps me motivated every single day.",
      image: ""
    },
    {
      name: "Emily Chen",
      ...
      rating: 5,
      text: "The group classes are so energetic and fun! From HIIT to yoga, there's something for every mood and fitness goal.",
      image: ""
    },
    {
      name: "David Thompson",
